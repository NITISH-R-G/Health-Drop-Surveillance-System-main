...
export const testingLabs: Lab[] = [
  ...
  },
  {
    ...
    distance: '3.5 km',
    accredited: true,
    services: ['General Pathology', 'Microbiology'],
    coordinates: { lat: 10.9995, lng: 76.9734 },
  },
  {
    id: '6',
    name: 'TWAD Board Water Testing Lab',
    type: 'water',
    ...
    distance: '1.2 km',
    accredited: true,
    services: ['Drinking water analysis', 'Chemical testing', 'Bacteriological test'],
    coordinates: { lat: 11.0183, lng: 76.9663 },
  },
  {
    id: '7',
    name: 'Siruvani Water Quality Lab',
    type: 'water',
    ...
    distance: '2.8 km',
    accredited: true,
    services: ['Water pH testing', 'Turbidity analysis', 'Heavy metal detection'],
    coordinates: { lat: 11.0084, lng: 76.9491 },
  },
];
