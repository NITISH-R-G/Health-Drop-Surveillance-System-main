...
export const testingLabs: TestingLab[] = [
  {
    id: '1',
  ...
  },
  {
    ...
    address: 'Avinashi Road, Coimbatore - 641014',
    phone: '0422-4360400',
    email: 'coimbatore@aravind.org',
    timings: '07:30 AM - 06:00 PM',
    isOpen: true,
    distance: '2.8 km',
    accredited: true,
    services: ['Ocular pathology', 'Microbiology'],
    coordinates: { lat: 11.02619, lng: 77.01423 },
  },
  {
    id: '10',
    name: 'Sankara Eye Hospital',
    type: 'pathology',
    address: 'Sathy Road, Coimbatore - 641035',
    phone: '0422-2666450',
    ...
    coordinates: { lat: 11.066497, lng: 76.998463 },
  },
  {
    id: '11',
    name: 'Rex Ortho Hospital Lab',
    type: 'pathology',
    address: 'R.S. Puram, Coimbatore - 641002',
    phone: '0422-2544544',
    email: 'rexortho@yahoo.co.in',
    timings: '09:00 AM - 09:00 PM',
    isOpen: true,
    distance: '5.8 km',
    accredited: false,
    services: ['Routine pathology'],
    coordinates: { lat: 11.0098, lng: 76.9532 },
  },
  {
    id: '12',
    ...
    phone: '0422-2672323',
    email: 'sriabiramihospital@gmail.com',
    timings: '24 Hours',
    isOpen: true,
    distance: '8.2 km',
    accredited: true,
    services: ['Complete Health Checkup', 'Water testing'],
