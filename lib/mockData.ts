...
export const testingLabsData: TestingLab[] = [
  {
    id: '1',
  ...
  },
  {
    ...
    distance: '5.0 km',
    accredited: true,
    services: ['Diagnostic Pathology', 'Blood Bank'],
    coordinates: { lat: 10.998, lng: 77.001 },
  },
  {
    id: '6',
    name: 'Tamil Nadu Water Supply and Drainage Board (TWAD)',
    type: 'water',
    address: 'Bharathi Park Road, Saibaba Colony, Coimbatore',
    phone: '0422-2432244',
    email: 'twad_cbe@yahoo.com',
    timings: '10:00 AM - 05:00 PM (Closed Sun)',
    isOpen: false,
    distance: '6.5 km',
    accredited: true,
    services: ['Drinking water analysis', 'Bacterial test', 'Chemical test'],
    coordinates: { lat: 11.032, lng: 76.95 },
  },
];
