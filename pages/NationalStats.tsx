...
const trendData = [
  42, 38, 55, 47, 62, 58, 71, 65, 53, 48, 44, 39, 35, 41, 52, 49, 37, 33, 29, 31, 28, 25, 22, 26,
  30, 34, 28, 24, 21, 19,
];
...
const NationalStats: React.FC<NationalStatsProps> = ({ onNavigate }) => {
  ...
  const diseases: DiseaseCounter[] = [
    {
      name: 'Cholera (API IND)',
      count: choleraCases ?? 14210,
      icon: 'water',
      color: '#FF3B30',
      isLive: choleraCases !== null,
    },
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.summaryGrid}>
        ...
        <BlurView
          ...
          <Text style={[styles.summaryLabel, { color: colors.primary }]}>
            {isLoadingLive ? 'Fetching Live Data...' : 'Cholera Deaths (WHO GHO API)'}
          </Text>
                ...
                <View
                  style={[
                    styles.trendBar,
                    {
                      ...
                      backgroundColor:
                        val > 50 ? colors.error : val > 30 ? colors.warning : colors.success,
        ...
        <View style={styles.tableHeader}>
          ...
          <View style={styles.sortButtons}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}>
              <Text style={[styles.sortBtnText, sortBy === 'total' && styles.sortBtnTextActive]}>
                Total
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              activeOpacity={0.7}>
              <Text style={[styles.sortBtnText, sortBy === 'active' && styles.sortBtnTextActive]}>
                Active
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <BlurView
          ...
          {sortedStates.map((state, idx) => (
            <View key={state.name} style={[styles.stateRow, idx % 2 === 0 && styles.stateRowAlt]}>
              ...
              <Text style={[styles.stateVal, { color: colors.error }]}>
                {state.active.toLocaleString()}
              </Text>
              <Text style={[styles.stateVal, { color: colors.success }]}>
                {state.recovered.toLocaleString()}
              </Text>
              <Text style={[styles.stateVal, { color: colors.textSecondary }]}>
                {state.deceased.toLocaleString()}
              </Text>
              <Text style={[styles.stateVal, { fontWeight: '700' }]}>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>
          Data source: National Water-Borne Disease Surveillance Program
        </Text>
