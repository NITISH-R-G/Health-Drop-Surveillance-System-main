...
const TrendChart: React.FC<TrendChartProps> = ({
  ...
  const previousValue =
    compareIndex >= 0 && compareIndex < data.length
      ? (data[compareIndex]?.value ?? 0)
      : latestValue;
          ...
          : (() => {
              ...
              const points = data
                .map((point, index) => {
                  ...
                  const y =
                    height - 24 - ((point.value - minValue) / Math.max(range, 1)) * (height - 24);
                  ...
                  <Svg
                    ...
                    {data.map((point, index) => {
                      ...
                      const y =
                        height -
                        24 -
                        ((point.value - minValue) / Math.max(range, 1)) * (height - 24);
                      const isScrubbing = activeIndex !== null;
                      const isActive = activeIndex === index;
                      return (
                        <Circle
