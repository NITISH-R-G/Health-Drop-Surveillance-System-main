...
const LabItem = React.memo(({ lab, colors, styles, handleCall, handleDirections }: any) => {
...
const TestingLabs: React.FC<TestingLabsProps & { ListHeaderComponent?: React.ReactNode }> = ({
  labs = defaultLabs,
  ListHeaderComponent,
}) => {
  ...
  const renderHeader = useCallback(
    ...
    [ListHeaderComponent, colors, filter, isLocating, styles, userLoc, handleGetLocation]
  );
