...
const TestingLabs: React.FC<TestingLabsProps> = ({ labs: propsLabs }) => {
  ...
  const labs = propsLabs || syncedLabs || [];
  ...
  const renderHeader = useCallback(
    ...
    [colors, filter, handleGetLocation, isLocating, styles, userLoc]
  );
  ...
  const renderItem = useCallback(
    ...
    [colors, handleCall, handleDirections, styles]
  );
