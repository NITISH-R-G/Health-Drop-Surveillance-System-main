...
const TestingLabs: React.FC<TestingLabsProps> = (props) => {
  ...
  const { data: syncedLabs, loading } = useSyncData('testingLabs');

  const labsToUse = props.labs || syncedLabs || [];

  const sortedLabs = useMemo(() => {
    const filteredLabs = filter === 'all' ? labsToUse : labsToUse.filter((l) => l.type === filter);
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterRow}>
            <TouchableOpacity
              ...
              <Text
                style={[
                  styles.filterLabel,
                  userLoc && { color: colors.success, fontWeight: '600' },
                ]}>
                  ...
                  <View style={styles.labInfo}>
                    ...
                    <View style={styles.contactRow}>
                      <View style={styles.contactItemWrapper}>
                        ...
                        <Text style={styles.contactItemInfo}>
                          {lab.timings || 'Contact to verify'}
                        </Text>
                      </View>
                      <View
                        style={[
