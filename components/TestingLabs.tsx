...
const TestingLabs: React.FC<TestingLabsProps> = ({ labs }) => {
  ...
  const actualLabs = labs || syncedLabs || [];

  const sortedLabs = useMemo(() => {
    const filteredLabs =
      filter === 'all' ? actualLabs : actualLabs.filter((l: TestingLab) => l.type === filter);
