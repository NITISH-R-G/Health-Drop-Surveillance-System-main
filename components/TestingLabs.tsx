...
const LabCard = React.memo(({ lab, colors, styles, onCall, onDirections }: LabCardProps) => {
...
const TestingLabs: React.FC<TestingLabsProps> = ({ labs = defaultLabs }) => {
  ...
  const handleDirections = useCallback((name: string, address: string) => {
  ...
  const renderItem = useCallback(
    ...
    [colors, styles, handleCall, handleDirections]
  );
