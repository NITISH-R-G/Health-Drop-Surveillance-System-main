...
const RiskHeatmap: React.FC<RiskHeatmapProps> = ({ selectedRegion = 'all' }) => {
  ...
  const activeContaminations = waterQualityAlerts.filter(
    (w) => selectedRegion === 'all' || w.regionId === selectedRegion
  );
    ...
    <BlurView
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Geospatial overview of risk levels and water quality alerts
        </Text>
      </View>
