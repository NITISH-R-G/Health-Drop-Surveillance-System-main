...
const HealthCertificate: React.FC<HealthCertificateProps> = ({
  ...
  const statusConfig = {
    low: {
      ...
      message: 'No water-borne disease risk detected',
    },
    moderate: {
      color: '#FFAB00',
      ...
      label: 'ADVISORY',
      icon: 'warning',
      message: 'Moderate risk — precautions advised',
    },
    high: {
      color: '#FF3D00',
      ...
      label: 'RESTRICTED',
      icon: 'alert-circle',
      message: 'High risk — medical clearance needed',
    },
    critical: {
      color: '#D50000',
      ...
      label: 'NOT CLEARED',
      icon: 'close-circle',
      message: 'Active infection suspected',
    },
  };
        ...
        <View style={styles.content}>
          ...
          <View style={styles.header}>
            ...
            <Animated.View
              style={[
                styles.statusBadge,
                { borderColor: status.color, backgroundColor: pulseBackgroundColor },
              ]}>
