...
const CategorizedMap: React.FC<CategorizedMapProps> = ({
  ...
  const markers = [
    {
      ...
      longitude: 77.0188,
      cases: 58,
      title: 'Cholera Alert (Singanallur)',
      desc: 'Critical: 58 active cases reported recently.',
    },
    {
      id: 6,
      type: 'outbreak',
      ...
      longitude: 76.9611,
      cases: 12,
      title: 'Cholera Tracking (Kuruchi)',
      desc: '12 active cases under observation.',
    },
    {
      id: 2,
      type: 'water',
      ...
      longitude: 76.9583,
      title: 'Ukkadam Tank',
      desc: 'Contamination detected (High pH / Foul Smell)',
    },
    {
      id: 3,
      type: 'hospital',
      latitude: 11.0069,
      longitude: 76.9454,
      title: 'City General (RS Puram)',
      desc: 'Beds available: 12. Safe Zone.',
    },
    {
      id: 4,
      type: 'water',
      latitude: 11.0264,
      longitude: 77.0041,
      title: 'Peelamedu Pump #12',
      desc: 'Safe to drink. Recent test passed.',
    },
    {
      id: 5,
      type: 'outbreak',
      ...
      longitude: 77.0016,
      cases: 18,
      title: 'Viral Fever (Vellalore)',
      desc: 'Cluster detected near the dumping ground.',
    },
    {
      id: 7,
      type: 'outbreak',
      ...
      longitude: 76.9669,
      cases: 35,
      title: 'Dengue Zone (Gandhipuram)',
      desc: 'High risk: Mosquito breeding grounds identified.',
    },
  ];
          ...
          <ScrollView
            ...
            {categories.map((cat) => (
              <TouchableOpacity
                ...
                />
                <Text
                  style={[styles.filterText, activeCategory === cat.id && styles.filterTextActive]}>
                  {cat.label}
                </Text>
              </TouchableOpacity>
            ))}
              ...
              <React.Fragment key={marker.id}>
                ...
                <Marker
                  ...
                  <View style={[styles.pin, { backgroundColor: color }]}>
                    <Ionicons name={getMarkerIcon(marker.type)} size={12} color="#fff" />
                  </View>
                </Marker>
              </React.Fragment>
            );
