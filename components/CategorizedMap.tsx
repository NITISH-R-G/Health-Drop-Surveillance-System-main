...
const CategorizedMap: React.FC<CategorizedMapProps> = ({ userLocation = 'Locating...', compact = false, onExpand }) => {
...
const createStyles = (colors: Theme) => StyleSheet.create({
  ...
  filterChip: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: spacing.md, paddingVertical: 6, borderRadius: radius.lg, backgroundColor: colors.surfaceVariant, borderWidth: 1, borderColor: colors.border },
